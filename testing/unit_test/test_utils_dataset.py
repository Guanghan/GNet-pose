...
from utils_dataset import batchload_gt_decimal_coords_from_dataset
from utils_io_folder import create_folder

def test_batchload_gt_decimal_coords_from_dataset():
    dataset_annotation_path = '/home/ngh/dev/ROLO-dev/benchmark/ILSVRC2015/Annotations/VID/train/ILSVRC2015_VID_train_0000'
    ...
    for batch_pairs in list_batch_pairs[0:2]:
        ...
        batch_gt_decimal_coords = batchload_gt_decimal_coords_from_dataset(dataset_annotation_path, batch_subfolder_names, batch_frame_ids, offset)
...
def main():
    ...
    finished = test_batchload_gt_decimal_coords_from_dataset()
